...
import w9057646.tees.ac.uk.scrup.Constants;
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_RCYCLA_TABLE = "CREATE TABLE " + Constants.TABLE_NAME + "("
                + Constants.KEY_ID + " INTEGER PRIMARY KEY,"
                + Constants.KEY_RCYCLA_ITEM + " INTEGER,"
                + Constants.KEY_COLOR + " TEXT,"
                + Constants.KEY_QTY_NUMBER + " INTEGER,"
                + Constants.KEY_ITEM_SIZE + " INTEGER,"
                //+ Constants.KEY_ITEM_IMAGE + "BYTE,"
                + Constants.KEY_DATE_NAME + " LONG);";


        db.execSQL(CREATE_RCYCLA_TABLE);
    ...
    public void addItem(Item item)  {
        ...
        values.put(Constants.KEY_RCYCLA_ITEM, item.getItemName());
        ...
        //values.put(Constants.KEY_ITEM_IMAGE, item.getItemImage());
    ...
    public Item getItem(int id) {
        ...
        Cursor cursor = db.query(Constants.TABLE_NAME,
                new String[]{Constants.KEY_ID,
                        Constants.KEY_RCYCLA_ITEM,
                        Constants.KEY_COLOR,
                        Constants.KEY_QTY_NUMBER,
                        Constants.KEY_ITEM_SIZE,
                        //Constants.KEY_ITEM_IMAGE,
        ...
        if (cursor != null) {
            ...
            item.setItemName(cursor.getString(cursor.getColumnIndex(Constants.KEY_RCYCLA_ITEM)));
            ...
            //item.setItemImage(cursor.getBlob(cursor.getColumnIndex(Constants.KEY_ITEM_IMAGE)));
